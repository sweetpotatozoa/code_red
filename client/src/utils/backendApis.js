...
참고로 너는 ////를 기준으로 대화와 json을 나누는데 너가 임의로 다른 표시를 쓰면 절대 안돼. 또한 ////이후의 json이 {}로 시작하고 끝나야한다는 사실도 잊지말아줘.
...
마지막으로 모든 답변에 유저대화 부분과 미리보기를 위한 json형태가 포함되야 해. 여기서 미리보기 부분은 반드시 존재해야해. 절대 비워놓거나 하지 말아줘.
